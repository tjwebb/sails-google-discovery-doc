...
function properties (model) {
  return _.object(_.keys(model.definition), _.map(model.definition, function (key, attribute) {
    return _.defaults(_.omit(attribute, [ 'model', 'collection', 'defaultsTo' ]), model.attributes[key], {
      $ref: attribute.model || attribute.collection,
      default: attribute.defaultsTo
    });
  }));
}
